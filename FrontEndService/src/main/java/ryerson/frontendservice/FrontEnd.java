 ...
 */
package ryerson.frontendservice;
        ...
        switch (hiddenParam) {
            case "Login":
                ...
                if (isAuthenticated) {
                    ...
                    request.setAttribute("moviesInfo", Business.getMovies());
                    request.setAttribute("username",username);
                    RequestDispatcher requestDispatcher = request.
                            getRequestDispatcher("userMovies.jsp");
                    ...
                    RequestDispatcher requestDispatcher = request.
                            getRequestDispatcher("failedLogin.jsp");
                    requestDispatcher.forward(request, response);
                }
          
                break;
            case "managerPortal":
                    RequestDispatcher requestDispatcher = request.getRequestDispatcher("managerLoginScreen.jsp");
                    requestDispatcher.forward(request, response);

                    break;
            case "ManagerLogin":
                boolean isAuthenticatedManager = Business.isAuthenticatedManager(username, passwrod);
                if (isAuthenticatedManager) {
                    ...
                    RequestDispatcher rq = request.getRequestDispatcher("managerScreen.jsp");
