            ...
            public void onNext(EventReceive value) {
                try {
                    ...
                    if(msgParts.length==4){
                        if(msgParts[0].equals("ADDMOVIE")){
                        
                            String name = msgParts[1];
                            String date = msgParts[2];
                            String seats = msgParts[3];
                            String address = msgParts[4];
                            String time = msgParts[5];
                            Manager_CRUD.createMovie(name, date, Integer.parseInt(seats), address, time);
                        }
                    }
